...
passport.use(
    new UserAppStrategy({
        appId: '55a84c513c0a3' // Your UserApp App Id: https://help.userapp.io/customer/portal/articles/1322336-how-do-i-find-my-app-id-
    },
...
/* 
 * To get the articles, you need to have a valid UserApp session token in
 * a cookie named `ua_session_token` which has been provided by the AngularJS front-end.
